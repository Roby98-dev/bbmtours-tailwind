    ...
    <div class="wrapper">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    <td colspan="2">
                        <input type="submit" name="submit" value="Save" class="bg-green-500 rounded-full px-4 py-1 text-gray-100 cursor-pointer">
                    </td>
                </tr>
        ...
        if (isset($_POST['submit'])) {
            ...
            if (isset($_FILES['image']['name'])) {
                ...
                if ($image_name != "") {
                    ...
                    $image_name = "Destination_Category_" . rand(000, 999) . '.' . $ext;
