...
<div class="bg-gray-200 md:ml-16 lg:ml-60 px-2 py-10">
    <div class="py-5">
        <h1 class="text-center text-green-500 font-semibold text-4xl uppercase">Category</h1>
    ...
    <div class="max-w-6xl">
        ...
        <a href="<?php echo SITEURL; ?>admin/add-category.php" class="bg-blue-500 px-4 font-semibold rounded py-1 text-gray-200"><i class="bx bx-plus"></i> Category</a>
