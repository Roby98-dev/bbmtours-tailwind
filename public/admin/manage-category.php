...
<div class="bg-gray-200 md:ml-16 lg:ml-60 px-2 py-10">
    <h1 class="text-center text-gray-500 text-lg uppercase">Categorys</h1>
    <div class="max-w-6xl">
        ...
        <a href="<?php echo SITEURL; ?>admin/add-category.php" class="bg-blue-500 px-4 font-semibold rounded-full py-1 text-gray-200"><i class="bx bx-plus"></i> Category</a>
